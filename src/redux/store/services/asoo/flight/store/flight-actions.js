...
export const SET_ITEM_PENDING = "FLIGHT/SET_PENDING";
export const path = '/Flights/Flight'
...
export function getItems(pagination, filter) {
    return async (dispatch, getState, {axios}) => {
        try {
            ...
            const defaultPath = profile.roles.includes('Teacher') ? '/Flights/GetData/Flight/Pilot': (
              profile.roles.includes('Student') ? '/Flights/GetData/Flight/CoPilot': '/Flights/Flight'
            )
